...
import { IconButton } from "../../../editor1/IconButton";
...
export function OpenLinkPlugin() {
  ...
  return (
    <div
      ...
      className={`absolute flex items-center justify-between gap-[2px] rounded-md border-[1px] border-slate-300 bg-slate-100 p-1 ${
